...
from ckan.plugins import IMiddleware, IConfigurable
from middleware import WordpresserException
from middleware import WordpresserMiddleware
...
class Wordpresser(SingletonPlugin):
    ...
    def make_middleware(self, app, config):
        return WordpresserMiddleware(app, config)
